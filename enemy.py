...
class Enemy:
    ...
    def __init__(self):
        ...
        self.speed = []
        self.small_speed = 200 * dt
        self.medium_speed = 100 * dt
        self.big_speed = 50 * dt
    ...
    def big_enemy(self):
        ...
        self.speed.append(self.big_speed)
    ...
    def medium_enemy(self):
        ...
        self.speed.append(self.medium_speed)
        self.x.append(random.randint(10, 750))
        self.y.append(random.randint(-1000, -100))
    ...
    def small_enemy(self):
        ...
        self.speed.append(self.small_speed)
        self.x.append(random.randint(10, 750))
        self.y.append(random.randint(-1000, -100))
        ...
        for i in range(self.numbers):
            ...
            if self.y[i] >= 1000:
                ...
                if rand >= 0 and rand <= 15:
                    ...
                    self.speed[i] = self.small_speed
                elif rand >= 16 and rand <= 18:
                    self.type[i] = 1
                    self.hp[i] = self.medhp
                    self.speed[i] = self.medium_speed
                elif rand >= 19:
                    self.type[i] = 2
                    self.hp[i] = self.bighp
                    self.speed[i] = self.big_speed
    ...
    def run(self,prect, brect):
        if self.start == 0:
            self.init()
            self.start = 1
        self.update(prect, brect)
        self.draw()
